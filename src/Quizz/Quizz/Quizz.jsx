    ...
    return (
        ...
        {!showResult ? (
            <div>
                ...
                <h2 style={{color: theme.palette.common.black, margin: '1em 2em'}}>{selectedQuestions[activeQuestion].question}</h2>
                <FormControl id='input' style={{margin:'auto', width: '60%'}}>
                    <OutlinedInput
                    autoComplete='off'
                    id='answer'
                    type="text"
